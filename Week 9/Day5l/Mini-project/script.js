...
// // Add click event listeners to previous search elements
// const previousSearchElements = document.querySelectorAll("#previousSearches li");
// for (let i = 0; i < previousSearchElements.length; i++) {
//   previousSearchElements[i].addEventListener("click", () => {
//     const cityName = previousSearchElements[i].textContent;
//     getCityWeather(cityName).then(data => {
//       if (data) {
//         cityWeatherData = data;
//         displayWeatherData();
//       } else {
