...
const users = ["Lea123", "Princess45", "cat&doglovers", "helooo@000", "Alexis2340"];

if (users.length === 0) console.log("No one is online")
if (users.length === 1) console.log([0] + " is online")
if (users.length === 2) console.log([0] + " and " + [1] + " is online")
